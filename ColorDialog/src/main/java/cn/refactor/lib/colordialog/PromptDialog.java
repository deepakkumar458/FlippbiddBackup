...
public class PromptDialog extends Dialog {
    ...
    private boolean mIsShowAnim,mIsSingleButton;
    private CharSequence mTitle, mContent, mBtnText, mBtnTextNag;
    ...
    private void initView() {
        ...
        btnNegative.setText(mBtnTextNag);

        showWithSingle(mIsSingleButton);
    }
    ...
    private void showWithSingle(boolean showInSingleButton) {
        if (showInSingleButton) {
    ...
    public PromptDialog setSingleButton(boolean enable) {
        mIsSingleButton = enable;
        return this;
    }
