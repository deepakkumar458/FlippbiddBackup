            ...
            holder.itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (Util.detectIntent(mContext, intent)) {
                        ((Activity) mContext).startActivityIfNeeded(intent, Constant.REQUEST_CODE_TAKE_IMAGE);
                    } else {
            ...
            if (isNeedImagePager) {
                holder.itemView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        ((Activity) mContext).startActivityIfNeeded(intent, Constant.REQUEST_CODE_BROWSER_IMAGE);
                    }
                });
            } else {
