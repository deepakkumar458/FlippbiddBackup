package com.flippbidd.sendbirdSdk.call;
...
import com.flippbidd.sendbirdSdk.widget.EndResultUtils;
import com.flippbidd.sendbirdSdk.widget.UserInfoUtils;
...
public abstract class NewCallActivity extends AppCompatActivity {
    ...
    String mCalleeIdToDial, mIsUserName;
...
//    ImageView mImageViewAccept;
    ...
    //+ CallService
    private NewCallService mCallService;
    ...
    private void init() {
        ...
        mState = (STATE) intent.getSerializableExtra(NewCallService.EXTRA_CALL_STATE);
        mCallId = intent.getStringExtra(NewCallService.EXTRA_CALL_ID);
        mIsVideoCall = intent.getBooleanExtra(NewCallService.EXTRA_IS_VIDEO_CALL, false);
        mIsUserName = intent.getStringExtra(NewCallService.EXTRA_REMOTE_NICKNAME);
        mCalleeIdToDial = intent.getStringExtra(NewCallService.EXTRA_CALLEE_ID_TO_DIAL);
        mDoDial = intent.getBooleanExtra(NewCallService.EXTRA_DO_DIAL, false);
        mDoAccept = intent.getBooleanExtra(NewCallService.EXTRA_DO_ACCEPT, false);
        mDoLocalVideoStart = intent.getBooleanExtra(NewCallService.EXTRA_DO_LOCAL_VIDEO_START, false);

        mDoEnd = intent.getBooleanExtra(NewCallService.EXTRA_DO_END, false);
        ...
        if (call != null) {
            call.setListener(new DirectCallListener() {
                ...
                public void onLocalVideoSettingsChanged(DirectCall call) {
                    ...
                    if (NewCallActivity.this instanceof NewVoiceCallActivity) {
                        ((NewVideoCallActivity) NewCallActivity.this).setLocalVideoSettings(call);
                    }
//                    if (NewCallActivity.this instanceof NewVideoCallActivity) {
//                        ((NewVideoCallActivity) NewCallActivity.this).setLocalVideoSettings(call);
//                    }
                }
...
//        mTextViewUserId.setText(getRemoteNicknameOrUserId(call));
        mTextViewUserId.setText(mIsUserName);
    ...
    private ServiceConnection mCallServiceConnection = new ServiceConnection() {
        ...
        public void onServiceConnected(ComponentName componentName, IBinder iBinder) {
            ...
            NewCallService.CallBinder callBinder = (NewCallService.CallBinder) iBinder;
    ...
    private void bindCallService() {
        ...
        bindService(new Intent(this, NewCallService.class), mCallServiceConnection, Context.BIND_AUTO_CREATE);
    }
    ...
    private void stopCallService() {
        ...
        NewCallService.stopService(mContext);
    }
    ...
    protected void updateCallService() {
        if (mCallService != null) {
            ...
            NewCallService.ServiceData serviceData = new NewCallService.ServiceData();
