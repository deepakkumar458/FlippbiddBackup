...
import com.flippbidd.sendbirdSdk.widget.MessageStatusView;
...
import static com.flippbidd.utils.SyncManagerUtils.getMyUserId;
...
class GroupChatAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private String ACTION_VIEW = "ACTION_VIEW",ACTION_PROFILE="ACTION_PROFILE";
    ...
    interface OnItemClickListener {
        void onUserMessageItemClick(UserMessage message,String actionType);

        void onFileMessageItemClick(FileMessage message,String actionType);
    ...
    private class MyUserMessageHolder extends BaseViewHolder {
        CustomTextView messageText, editedText, timeText;
        ViewGroup urlPreviewContainer;
        CustomTextView urlPreviewSiteNameText, urlPreviewTitleText, urlPreviewDescriptionText;
        ...
        MyUserMessageHolder(View itemView) {
            ...
            messageText = (CustomTextView) itemView.findViewById(R.id.text_group_chat_message);
            editedText = (CustomTextView) itemView.findViewById(R.id.text_group_chat_edited);
            timeText = (CustomTextView) itemView.findViewById(R.id.text_group_chat_time);
            ...
            urlPreviewSiteNameText = (CustomTextView) itemView.findViewById(R.id.text_url_preview_site_name);
            urlPreviewTitleText = (CustomTextView) itemView.findViewById(R.id.text_url_preview_title);
            urlPreviewDescriptionText = (CustomTextView) itemView.findViewById(R.id.text_url_preview_description);
        ...
        void bind(Context context, final UserMessage message, GroupChannel channel, boolean isContinuous, boolean isNewDay, final OnItemClickListener clickListener, final OnItemLongClickListener longClickListener, final int position) {
            super.bind(message, isNewDay);
            Log.e("TAG", "messageCounts ==>" + messageCounts);
            messageText.setText(message.getMessage());
            timeText.setText(DateUtils.formatTimeWithMarker(message.getCreatedAt()));
            ...
            if (clickListener != null) {
                itemView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        clickListener.onUserMessageItemClick(message,ACTION_VIEW);
                    }
                });
            }
    ...
    private class OtherUserMessageHolder extends BaseViewHolder {
        CustomTextView messageText, editedText, nicknameText, timeText;
        ...
        public OtherUserMessageHolder(View itemView) {
            ...
            editedText = (CustomTextView) itemView.findViewById(R.id.text_group_chat_edited);
            timeText = (CustomTextView) itemView.findViewById(R.id.text_group_chat_time);
            nicknameText = (CustomTextView) itemView.findViewById(R.id.text_group_chat_nickname);
        ...
        void bind(Context context, final UserMessage message, GroupChannel channel, boolean isNewDay, boolean isContinuous, final OnItemClickListener clickListener, final OnItemLongClickListener longClickListener, final int position) {
            ...
            if (isContinuous) {
                ...
                if (message.getSender().getProfileUrl() != null && !message.getSender().getProfileUrl().equalsIgnoreCase("")) {
            ...
            if (clickListener != null) {
                ...
                profileImage.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        clickListener.onUserMessageItemClick(message,ACTION_PROFILE);
                    }
                });
            }
            if (longClickListener != null) {
    ...
    private class MyFileMessageHolder extends BaseViewHolder {
        CustomTextView fileNameText, timeText;
        MessageStatusView messageStatusView;
        ...
        public MyFileMessageHolder(View itemView) {
            ...
            timeText = (CustomTextView) itemView.findViewById(R.id.text_group_chat_time);
            fileNameText = (CustomTextView) itemView.findViewById(R.id.text_group_chat_file_name);
            messageStatusView = itemView.findViewById(R.id.message_status_group_chat);
        }
        ...
        void bind(Context context, final FileMessage message, GroupChannel channel, boolean isNewDay, final OnItemClickListener listener) {
            ...
            if (listener != null) {
                itemView.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        listener.onFileMessageItemClick(message,ACTION_VIEW);
                    }
                });
            }
    ...
    private class OtherFileMessageHolder extends BaseViewHolder {
        CustomTextView nicknameText, timeText, fileNameText, fileSizeText;
        ImageView profileImage;
        ...
        public OtherFileMessageHolder(View itemView) {
            ...
            timeText = (CustomTextView) itemView.findViewById(R.id.text_group_chat_time);
            fileNameText = (CustomTextView) itemView.findViewById(R.id.text_group_chat_file_name);
//            fileSizeText = (CustomTextView) itemView.findViewById(R.id.text_group_chat_file_size);
...
//            fileSizeText.setText(String.valueOf(message.getSize()));
            ...
            if (listener != null) {
                ...
                profileImage.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View view) {
                        listener.onFileMessageItemClick(message,ACTION_PROFILE);
                    }
                });
            }
        }
    ...
    private class OtherImageFileMessageHolder extends BaseViewHolder {
        ...
        CustomTextView timeText, nicknameText;
    ...
    public int messageCountsChecked(List<BaseMessage> messages) {
        messageCounts=0;
        synchronized (mMessageList) {
            for (BaseMessage message : messages) {
                if (message instanceof UserMessage) {
                    if (((UserMessage) message).getSender().getUserId().equals(getMyUserId())) {
                        messageCounts++;
                    }
                } else if (message instanceof FileMessage) {
                    if (((FileMessage) message).getSender().getUserId().equals(getMyUserId())) {
                        messageCounts++;
                    }
                }
            }
    ...
    public int getMessageCounts() {
        ...
        List<BaseMessage> mMessageListFinal = new ArrayList<>();
        mMessageListFinal.addAll(mFailedMessageList);
        mMessageListFinal.addAll(mMessageList);
        Log.e("TAG","mFailedMessageList-->"+mFailedMessageList.size());
        Log.e("TAG","mMessageList-->"+mMessageList.size());
        Log.e("TAG","mMessageListFinal-->"+mMessageListFinal.size());
        if (mMessageListFinal != null && mMessageListFinal.size() != 0) {
            return messageCountsChecked(mMessageListFinal);
        }
        return 0;
    }
}
