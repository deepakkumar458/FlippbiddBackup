package com.flippbidd.sendbirdSdk.main;
...
public class ConnectionManager {
    ...
    public static void connect(final Context context, String userId, final String userNickname, final String url, final SendBird.ConnectHandler handler) {
